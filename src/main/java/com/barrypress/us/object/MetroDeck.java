...
public class MetroDeck extends Deck {

    public MetroDeck(Derby db) {
        super(db);
    }
    ...
    public void setup(Integer gameID, Integer type) {
        ...
        List<Integer> allCards = db.getAllExcept(Constants.CARD_METRO, Constants.OLYMPIC_GAMES, true);
        ...
        middle.addAll(db.getCardsByName(Constants.CARD_METRO, Constants.OLYMPIC_GAMES));
        ...
        db.writeDeck(gameID, Constants.CARD_METRO, draw, discard);
    }
}
